...
public class TabMelee {
    ...
    public static final String MoreModTetraTab="item_group.myosotis.melee_weapon";
    public static final Supplier<CreativeModeTab> materials=creative_mode_tab.register("item2",()-> CreativeModeTab.builder()
            //槽位位置
            .withTabsBefore(CreativeModeTabs.SPAWN_EGGS)
            //物品栏名称
            .title(Component.translatable(MoreModTetraTab))
            //图标
            .icon(MyItemRegister.MeleeWeaponTemplate.get()::getDefaultInstance)
            .displayItems((itemDisplayParameters, output) -> {
                // 遍历 CommonItem 列表中的物品
                for(RegistryObject<Item> curios: MyItemRegister.MeleeItem){
                    if(curios.isPresent()){
