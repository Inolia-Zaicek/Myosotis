...
public class Tab {
    ...
    public static final String MoreModTetraTab="item_group.myosotis.tab";
    public static final Supplier<CreativeModeTab> materials=creative_mode_tab.register("item",()-> CreativeModeTab.builder()
            ...
            //图标
            .icon(MyItemRegister.Myosotis1.get()::getDefaultInstance)
            .displayItems((itemDisplayParameters, output) -> {
                // 遍历 CommonItem 列表中的物品
                for(RegistryObject<Item> curios: MyItemRegister.CommonItem){
                    if(curios.isPresent()){
