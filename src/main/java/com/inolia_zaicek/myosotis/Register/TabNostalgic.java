...
public class TabNostalgic {
    ...
    public static final String MoreModTetraTab="item_group.myosotis.tab2";
    public static final Supplier<CreativeModeTab> materials=creative_mode_tab.register("item2",()-> CreativeModeTab.builder()
            ...
            //图标
            .icon(ItemRegister.SablePlume.get()::getDefaultInstance)
            .displayItems((itemDisplayParameters, output) -> {
                // 遍历 CommonItem 列表中的物品
                for(RegistryObject<Item> curios: ItemRegister.NostalgicItem){
                    if(curios.isPresent()){
