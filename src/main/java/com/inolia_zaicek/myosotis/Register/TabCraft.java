...
public class TabCraft {
    ...
    public static final String MoreModTetraTab="item_group.myosotis.tab3";
    public static final Supplier<CreativeModeTab> materials=creative_mode_tab.register("item3",()-> CreativeModeTab.builder()
            ...
            //图标
            .icon(ItemRegister.PureDarkMagicalCore.get()::getDefaultInstance)
            .displayItems((itemDisplayParameters, output) -> {
                // 遍历 CommonItem 列表中的物品
                for(RegistryObject<Item> curios: ItemRegister.CraftItem){
                    if(curios.isPresent()){
